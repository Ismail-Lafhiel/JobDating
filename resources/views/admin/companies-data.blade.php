                        ...
                        <tbody>
                            @foreach ($companies as $company)
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-3">{{ $company->industry_field }}</td>
                                    <td class="px-4 py-3">{{ $company->contact_info }}</td>
                                    <td class="px-4 py-3">{{ $company->created_at }}</td>
                                    <td class="px-4 py-3">{{ $company->updated_at }}</td>
                                    <td class="px-4 py-3 flex items-center justify-end">
                                        <button id="{{ $company->id }}-dropdown-dropdown-button"
                                        ...
                                        <div id="{{ $company->id }}-dropdown"
                                            ...
                                            <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                                aria-labelledby="{{ $company->id }}-dropdown-dropdown-button">
                                                <li>
