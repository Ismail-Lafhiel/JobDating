                ...
                <div
                    ...
                    <div
                        ...
                        <a href="#"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5 mr-2 fill-white"
                                viewBox="0 0 448 512">
                                <path
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-3">Industry Field</th>
                        ...
                        <tbody>
                            @foreach ($announcements as $announcement)
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-3">{{ $announcement->company->industry_field }}</td>
                                    <td class="px-4 py-3">{{ $announcement->created_at }}</td>
                                    <td class="px-4 py-3">{{ $announcement->updated_at }}</td>
                                    <td class="px-4 py-3 flex items-center justify-end">
                                        <button id="{{ $announcement->id }}-dropdown-dropdown-button"
                                        ...
                                        <div id="{{ $announcement->id }}-dropdown"
                                            ...
                                            <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                                aria-labelledby="{{ $announcement->id }}-dropdown-dropdown-button">
                                                <li>
                                            ...
                                            <div class="py-1">
                                                <form action="{{ route('announcements.destroy', $announcement->id) }}" method="post" onclick="return confirm('Are you sure you want to delete this announcement?')">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit"
