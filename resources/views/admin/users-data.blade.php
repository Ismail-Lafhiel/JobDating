                            ...
                            @foreach ($users as $user)
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-3 flex items-center justify-end">
                                        <button id="{{ $user->id }}-dropdown-dropdown-button"
                                        ...
                                        <div id="{{ $user->id }}-dropdown"
                                            ...
                                            <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                                aria-labelledby="{{ $user->id }}-dropdown-dropdown-button">
                                                <li>
                                                    <a href="{{ route('companies.show', $user->id) }}"
                                            ...
                                            <div class="py-1">
                                                <form action="{{ route('companies.destroy', $user->id) }}"
                                                    method="post"
